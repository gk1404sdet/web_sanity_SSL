...
public class CartPageSteps {
    ...
    public void user_clicks_the_postal_code_check_box() {

        cartPage.clickOnPincodeBox();
    }

    @When("user enters the invalid postal code")
    public void user_enters_the_invalid_postal_code() {
    ...
    public void user_clicks_the_check_option_to_validate_the_postal_code() {
